               ...
               <div class="card">
                  ...
                  <div class="card-body mx-5 my-3">
                     ...
                     <div class="text-center mt-3">
                        <p class="mb-1" style="font-size:14px;color:#666;">Belum punya akun?</p>
                        <div class="d-flex justify-content-center gap-2">
                          <a href="<?= base_url('daftar/siswa') ?>" class="btn btn-outline-primary btn-sm mr-2">
                            <i class="material-icons" style="font-size:14px;vertical-align:middle;">person_add</i>
                            Daftar Siswa
                          </a>
                          <a href="<?= base_url('daftar/guru') ?>" class="btn btn-outline-success btn-sm">
