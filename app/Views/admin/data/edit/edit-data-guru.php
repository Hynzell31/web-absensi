               ...
               <div class="card-body mx-5 my-3">
                  ...
                  <form action="<?= base_url('admin/guru/edit'); ?>" method="post">
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="text" id="kode_guru"
                           class="form-control <?= $validation->getError('kode_guru') ? 'is-invalid' : ''; ?>" name="kode_guru"
                           placeholder="Contoh: KG001" value="<?= old('kode_guru') ?? $oldInput['kode_guru'] ?? $data['kode_guru'] ?? '' ?>">
