            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <?php foreach ($data as $value): ?>
                        <?php
                        if ($kelas === 'Semua Kelas' && $currentKelas !== $value['nama_kelas']) {
                            $currentKelas = $value['nama_kelas'];
                            echo '<tr class="table-info"><td colspan="8" class="text-center"><b>KELAS ' . strtoupper($currentKelas) . '</b></td></tr>';
                        }
