        ...
        if (index <= numberOfItems) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (objSub.result == 1) {
                        // Display logic for Kelas: showing tingkat and index_kelas
                        if (objSub.status == 'duplicate') {
                            $("#csv_uploaded_files").prepend('<li class="list-group-item list-group-item-warning">&nbsp;' + objSub.index + '.&nbsp; - ' + objSub.kelas.tingkat + ' ' + objSub.kelas.index_kelas + ' (Sudah Ada)</li>');
                        } else {
                            $("#csv_uploaded_files").prepend('<li class="list-group-item list-group-item-success">&nbsp;' + objSub.index + '.&nbsp; - ' + objSub.kelas.tingkat + ' ' + objSub.kelas.index_kelas + '</li>');
                        }
                    } else {
